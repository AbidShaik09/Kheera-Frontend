  ...
  readonly taskSections: DashboardSection[] = [
    {
      ...
      tasks: [
        this.createTask('T300', 'Review authentication screens', 'TKD', 70, 'Kheera Frontend', 'done', -2),
        this.createTask('T301', 'Prepare signup release checklist', 'TKD', 71, 'Kheera Frontend', 'todo', -6),
        this.createTask('T302', 'Validate reset password flow', 'TKD', 72, 'Kheera Frontend', 'todo', -10),
      ],
    },
    {
      title: 'Last Month Tasks',
      tasks: [
        this.createTask('T260', 'Repair Angular unit-test runner', 'TKD', 69, 'Kheera Frontend', 'done', -12),
        this.createTask('T242', 'Document frontend workflow', 'TKD', 66, 'Kheera Frontend', 'done', -19),
      ],
    },
    {
      title: 'Earlier Tasks',
      tasks: [
        this.createTask('T190', 'Create reusable task card', 'TKD', 37, 'Kheera Frontend', 'todo', -45),
        this.createTask('T175', 'Plan dashboard page sections', 'TKD', 60, 'Kheera Frontend', 'todo', -52),
      ],
    },
  ];

...
- [ ] [#85](https://github.com/AbidShaik09/Kheera-Frontend/issues/85) Workspace shell, live space switcher and navigation. **In progress:** [issue plan](issue-plans/issue-85_workspace-navigation.md).
